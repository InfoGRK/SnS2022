...
# Version 2.0.4 (2022-07-03)                                                         #
# Changes in this version:                                                           #
# - information on each step of the script                                           #
...
print(paste("Done including all necessary libraries."))

### COLLECT .nc FILES ON A LIST ###
setwd("~/Documents/BIK/Swakelola2022/Carbon_Source_and_Sink")  # adjust to the right directory
...
if (type == "monthly"){
  ...
  if (month[1] == "12"){
    ncname <- paste0("CO2_mx_seasonal_DJF_20",year,".nc")
    ncname2 <- paste0("CO2_sns_seasonal_DJF_20",year,".nc")
    csvname <- paste0("CO2_seasonal_DJF_20",year,".csv")
  } else if (month[1] == "03"){
    ncname <- paste0("CO2_mx_seasonal_MAM_20",year,".nc")
    ncname2 <- paste0("CO2_sns_seasonal_MAM_20",year,".nc")
    csvname <- paste0("CO2_seasonal_MAM_20",year,".csv")
  } else if (month[1] == "06"){
    ncname <- paste0("CO2_mx_seasonal_JJA_20",year,".nc")
    ncname2 <- paste0("CO2_sns_seasonal_JJA_20",year,".nc")
    csvname <- paste0("CO2_seasonal_JJA_20",year,".csv")
  } else if (month[1] == "09"){
    ncname <- paste0("CO2_mx_seasonal_SON_20",year,".nc")
    ncname2 <- paste0("CO2_sns_seasonal_SON_20",year,".nc")
    csvname <- paste0("CO2_seasonal_SON_20",year,".csv")
  }
} else if (type == "annual"){
  ncname <- paste0("CO2_mx_annual_20",year,".nc")
  ncname2 <- paste0("CO2_sns_annual_20",year,".nc")
  csvname <- paste0("CO2_annual_20",year,".csv")
} else if (type == "all"){
  ncname <- paste0("CO2_mx_all_2015-2021.nc")
  ncname2 <- paste0("CO2_sns_all_2015-2021.nc")
  csvname <- paste0("CO2_all_2015-2021.csv")
}

print(paste("Done creating names for netcdf and csv files."))
...
print(paste("Done creating a dataframe from netcdf files"))
...
print(paste("Done creating the csv file."))
...
print(paste("Done creating the template for the output files."))
...
print(paste("Done building the IDW models and interpolating the data."))
