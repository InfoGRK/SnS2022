...
results_dir <- "C:/WORKING/SnS2022/SnS2022-1/localdata/OCO/results"
ncname <- file.path(results_dir,"mx",paste0(fvar, "_mx_", fdate,"_OCO-2.nc"))   # adjust to "OCO-3.nc"
ncname2 <- file.path(results_dir,"sns",paste0(fvar, "_sns_", fdate,"_OCO-2.nc"))   # adjust to "OCO-3.nc"
csvname <- file.path(results_dir,"csv",paste0(fvar, "_", fdate,"_OCO-2.csv"))  # adjust to "OCO-3.nc"
...
# rewrite the CRS because it will result in an error otherwise
